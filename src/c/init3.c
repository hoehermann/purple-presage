...
/*
 * This struct corresponds to G_DECLARE_FINAL_TYPE and G_DEFINE_DYNAMIC_TYPE_EXTENDED. 
 * No idea what it is needed for.
 */
struct _PresageProtocol {
